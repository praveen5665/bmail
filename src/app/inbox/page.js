...
export default function Inbox() {
  ...
  const fetchEmails = async () => {
    ...
    try {
      ...
      if (result.success && result.emails.length > 0) {
        ...
        // Filter emails where the current user is the recipient (case-insensitive)
        const inboxEmails = result.emails.filter(email => 
          email.to && email.to.toLowerCase() === user.ethAddress.toLowerCase()
        );
        console.log('Filtered inbox emails:', inboxEmails);
  ...
  return (
    <EmailLayout title="Inbox" emailCount={filteredEmails.length} activeTab="inbox">
      {/* Search and Filter */}
      ...
      <div className="divide-y divide-gray-200">
        {loadingEmails ? (
          ...
          <div className="text-center py-12">
            ...
            <p className="mt-1 text-sm text-gray-500">When you receive emails, they will appear here.</p>
            <div className="mt-6">
              <button
